...
type AwardBadgeType = "launching soon" | "product-of-the-day" | "product-of-the-month" | "product-of-the-week";
...
export const AwardBadge = ({ type, place, link }: AwardBadgeProps) => {
  ...
  const leaveTimeout1 = useRef<NodeJS.Timeout>();
  const leaveTimeout2 = useRef<NodeJS.Timeout>();
  const leaveTimeout3 = useRef<NodeJS.Timeout>();
  ...
  const overlayAnimations = Array.from(Array(10).keys()).map((e) => (
    `
